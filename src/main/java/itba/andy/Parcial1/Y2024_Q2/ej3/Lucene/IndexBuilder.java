...
public class IndexBuilder {
	...
	private static void createIndex() throws IOException {
		...
		List<String> fileIterator = itba.andy.TP2.Lucene.Utils.listFilesRelativePath("docs", Arrays.asList("txt"));
		for (String docFileName : fileIterator) {
			...
			// es imposible pedir a Lucene que lo almacene fuera del indice, pero si que
			// genere el indice
			...
			// el Path donde se encuentra fisicamente el documento no me interesa indexar
			// (nadie busca por path)
