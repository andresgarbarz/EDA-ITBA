...
public class EvaluatorPostfija2 {
    ...
    public static void main(String[] args) {
        EvaluatorPostfija2 evaluator = new EvaluatorPostfija2();
        Double rta = evaluator.evaluate("3 4 2 * 1 5 - 2 ^ 3 ^ / +");
        System.out.println(rta);

        String postfija = evaluator.infijaToPostfija("3 + 4 * 2 / ( 1 - 5 ) ^ 2 ^ 3");
        Double rta2 = evaluator.evaluate(postfija);
