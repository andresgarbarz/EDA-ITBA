...
import itba.andy.TP5C.BSTreeInterface;
import itba.andy.TP5C.NodeTreeInterface;
...
public class GraphicsTree<T extends Comparable<? super T>> extends Canvas {
	...
	private void drawLines(GraphicsContext gc, NodeTreeInterface<T> treeNode, double xMin, double xMax, double yMin,
			double yMax) {
		Point2D p1, p2;
		Line newLine;
	...
	private void drawCircles(GraphicsContext gc, NodeTreeInterface<T> treeNode, double xMin, double xMax, double yMin,
			double yMax) {
